...
# Provide the path to the JSON file and the directory where the images are stored
...
if __name__ == "__main__":
    register_coco_instances("my_data_train", {}, "/content/drive/MyDrive/DLProj/diffusiondet/train/_annotations.coco.json", "//content/drive/MyDrive/DLProj/diffusiondet/train")
    register_coco_instances("my_data_valid", {}, "/content/drive/MyDrive/DLProj/diffusiondet/valid/_annotations.coco.json", "/content/drive/MyDrive/DLProj/diffusiondet/valid")
